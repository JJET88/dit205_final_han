        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border-2 border-cyan-400/30 shadow-2xl shadow-cyan-500/20 rounded-3xl p-8 w-full max-w-2xl">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-cyan-500/20 via-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-cyan-400/30 rounded-full px-6 py-2 shadow-lg mb-4">
              ...
              <p className="text-sm font-bold text-cyan-400 tracking-wider">EDIT MODE</p>
              <span className="w-2 h-2 bg-cyan-400 rounded-full animate-pulse"></span>
            </div>
            ...
            <p className="text-cyan-300/80">
              ✏️ Update product information below
            </p>

            {/* Product ID Badge */}
            {id && (
              <div className="mt-4 inline-flex items-center gap-2 bg-slate-800/50 backdrop-blur-sm border border-purple-400/30 rounded-full px-4 py-2">
                <span className="text-xs text-purple-300 uppercase tracking-wider">Editing ID:</span>
              ...
              {form.coverimage && (
                <div className="mt-6 flex justify-center">
                  <div className="relative group">
                    <div className="absolute -inset-1 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 rounded-2xl blur-lg opacity-30 group-hover:opacity-50 transition-opacity duration-500"></div>
                    <img
                      src={form.coverimage}
                      alt="Preview"
                      className="relative w-64 h-64 object-cover rounded-2xl border-2 border-cyan-400/30 shadow-2xl transition-transform duration-300 group-hover:scale-105"
          ...
          <div className="mt-8 pt-6 border-t border-slate-700/50">
            <div className="flex items-center justify-center gap-4 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-400">All fields required</span>
              </div>
              <div className="w-px h-4 bg-slate-700"></div>
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-purple-400 rounded-full animate-pulse"></span>
                <span className="text-gray-400">Changes saved instantly</span>
              </div>
            </div>
          </div>
        </div>
